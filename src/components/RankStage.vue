...
<template>
  <div v-if="props?.list" :class="twMerge('', props.class)">
    <div class="row row-gap-8 !flex-nowrap items-end">
      <div
      class="col-12 shrink"
      :style="{
        maxWidth: props?.type === 'sale' ?'39%' :'61%',
      }">
        <div v-if="props?.type === 'sale'" class="relative">
      ...
      <div
      class="col-12 -mb-3 shrink"
      :style="{
        maxWidth: props?.type === 'sale' ?'61%' :'39%',
      }">
        <div
        class="relative">
                  ...
                  <div class="pl-5">
                    <div class="w-10 text-center">
                      <div v-if="index === 0" class="font-700 italic">
                        <img class="mx-auto" src="/assets/img/icon_crown2_2.svg" alt="">
                        <div>No.2</div>
                      </div>
                      <div v-else-if="index === 1" class="font-700 italic">
                        <img class="mx-auto" src="/assets/img/icon_crown2_3.svg" alt="">
                        <div class="text-[#E5AE89]">No.3</div>
                      </div>
                      <div v-else>
          ...
          <div v-else>
            ...
            class="btn btn-light relative z-10">
              ...
              <div class="row flex-nowrap items-center">
                ...
                <div class="col-12 shrink">
                  <div class="pr-5 text-right text-[14px]" v-html="node.number"></div>
                </div>
              </div>
